...
RUN set -eux; \
	...
	wget -O /usr/local/bin/gosu "https://gh-proxy.org/https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch"; \
	wget -O /usr/local/bin/gosu.asc "https://gh-proxy.org/https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc"; \
